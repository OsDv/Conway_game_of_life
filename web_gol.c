...
int main(){
    ...
    while(!WindowShouldClose()){
        ...
        ClearBackground(BLACK);
            ...
            DrawText("- WASD to move Camera", 40, 40, 12, CELL_COLOR);
            DrawText("- Mouse Wheel to Zoom in-out", 40, 60, 12, CELL_COLOR);
            DrawText("- R to rest the grid", 40, 80, 12, CELL_COLOR);
        EndDrawing();
    }
